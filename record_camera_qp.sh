...
CODEC=${1:-"h265"}
DURATION=${2:-30}
OUTPUT_FILE=${3:-"recording_${CODEC}_qp.mp4"}
...
set_camera_qp "$CODEC" 1  # QP=1 for maximum quality
...
echo "Starting maximum quality recording with QP=1..."
...
echo "Recording UHD (3840x2160) $CODEC with QP=1 (maximum quality)..."
